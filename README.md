...
<head>
    ...
    <title>اتقان - منصة التجارب العلمية والمحاكاة</title>
    ...
    <style>
        :root {
            ...
            --science-orange: #FF9800;
            --science-red: #F44336;
            --science-yellow: #FFEB3B;
            --science-teal: #009688;
            --science-pink: #E91E63;
            --science-cyan: #00BCD4;
            --science-indigo: #3F51B5;
            --science-lime: #CDDC39;
            --science-deep-orange: #FF5722;
            --science-brown: #795548;
            --science-gray: #9E9E9E;
            --science-blue-gray: #607D8B;
            
            --primary: var(--science-blue);
            --secondary: var(--science-orange);
            --accent: var(--science-teal);
            --dark: #0d1440;
            --light: #f5f5f5;
            --gray: #757575;
        }
        ...
        * {
        ...
        body {
            background: linear-gradient(135deg, var(--science-purple), var(--science-blue));
            color: var(--light);
            min-height: 100vh;
            line-height: 1.6;
        }
        ...
        .experiment-item.physics::before { background: var(--science-blue); }
    ...
    <div class="container">
        ...
        <div class="main-content">
            <div class="experiments-list fade-in">
                ...
                <div class="experiment-item chemistry" data-experiment="gases">
                    <div class="experiment-icon">
